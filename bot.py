...
BOT_USERNAME = os.getenv("BOT_USERNAME", "osintJit1_bot")  # Принудительно задаём правильное имя
...
def format_short(data, query, stats_count, search_type):
    ...
    if search_type == "phone":
        ...
        # Оператор/регион/страна - приоритет у DaData
        operator = None
        region = None
        country = None
        ...
        # Если DaData не дал данных, пробуем BigBase
