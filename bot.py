...
BASE_URL = os.getenv("BASE_URL", "https://api.depsearch.sbs")

if not BOT_TOKEN or not API_TOKEN:
    raise ValueError("❌ BOT_TOKEN и API_TOKEN обязательны!")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Кодируем запрос и формируем URL (без ?)
    q_encoded = quote(q)
