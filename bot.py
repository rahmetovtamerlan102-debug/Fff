...
DEP_TOKEN = os.getenv("DEP_TOKEN", "OsMTcjyHTRtfABnWA4V3d12SYKVIYE8z")  # рабочий токен по умолчанию
DEP_BASE = os.getenv("DEP_BASE", "https://api.depsearch.sbs")
LANG = "ru"
TIMEOUT = 30

if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN is required in .env or Render env vars")
...
def search_depsearch(query):
    ...
    try:
        ...
        if "text/html" in resp.headers.get("content-type", ""):
            return {"error": "API вернул HTML (возможно, защита Cloudflare). Попробуйте позже или обновите токен."}
