...
async def show_partial_form(update, context):
    """Показывает форму поиска по неполным данным"""
    partial = context.user_data.get('partial', {})
    
    # Формируем отображение заполненных полей
    fields_display = []
    field_names = {
        'lastname': 'Фамилия',
        'firstname': 'Имя',
    ...
    # Проверяем, был ли вызов из колбэка или из сообщения
